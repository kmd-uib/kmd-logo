...
function be() {
  ...
  return M.Fragment = c, M.jsx = l, M.jsxs = l, M;
}
var L = {};
var ne;
function _e() {
...
React keys must be passed directly to JSX without using spread:
  ...
  <%s key={someKey} {...props} />`,
      ...
      if (f = null, o !== void 0 && (l(o), f = "" + o), p(r) && (l(r.key), f = "" + r.key), "key" in r) {
        o = {};
        for (var Z in r)
          Z !== "key" && (o[Z] = r[Z]);
      } else o = r;
    ...
    var w = ge, O = /* @__PURE__ */ Symbol.for("react.transitional.element"), R = /* @__PURE__ */ Symbol.for("react.portal"), j = /* @__PURE__ */ Symbol.for("react.fragment"), T = /* @__PURE__ */ Symbol.for("react.strict_mode"), S = /* @__PURE__ */ Symbol.for("react.profiler"), _ = /* @__PURE__ */ Symbol.for("react.consumer"), y = /* @__PURE__ */ Symbol.for("react.context"), x = /* @__PURE__ */ Symbol.for("react.forward_ref"), m = /* @__PURE__ */ Symbol.for("react.suspense"), A = /* @__PURE__ */ Symbol.for("react.suspense_list"), F = /* @__PURE__ */ Symbol.for("react.memo"), P = /* @__PURE__ */ Symbol.for("react.lazy"), I = /* @__PURE__ */ Symbol.for("react.activity"), Ee = /* @__PURE__ */ Symbol.for("react.client.reference"), U = w.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE, K = Object.prototype.hasOwnProperty, we = Array.isArray, Y = console.createTask ? console.createTask : function() {
      return null;
    };
    w = {
...
const se = 1 / 60, ae = 2, ce = (t) => t.reduce((c, l) => c + l, 0), je = (t, c, l, { k: i, b: a, others: s, ki: p, krandom: h, fcap: g }) => {
  ...
  krandom: 1992700730,
  fcap: 15036
}, ue = 57, N = 81, ve = ({ id: t, letters: c, targetAnchors: l, width: i, direction: a, color: s, constants: p, style: h, href: g, link: d }) => {
  const E = a === C.VERTICAL, [v, b] = Q(
    () => l.map((x) => x * (i - ue))
  ), [w, O] = Q(
    () => c.map(() => 0)
    ...
    R.current = requestAnimationFrame(() => {
      ...
      b(x.map((m) => m.newX)), O(x.map((m) => m.newV)), x.every((m) => m.done) || j.current?.();
    });
  }, [v, w, i, p, l, c]);
  te(() => {
    j.current = T;
  ...
  const S = d?.fontSize ?? 10, _ = d ? S + 4 : 0, y = d ? /* @__PURE__ */ n.jsx(
    "a",
    {
      href: d.url,
      style: { position: "absolute", bottom: 0, left: 0, color: s, fontSize: S, lineHeight: 1, textDecoration: "none", whiteSpace: "nowrap" },
      children: d.name
    }
  ) : null;
  return E ? /* @__PURE__ */ n.jsxs(
    ...
    {
      id: t,
      style: { position: "relative", display: "block", width: N, height: i, paddingBottom: _, boxSizing: "content-box", ...h },
      href: g,
      title: "Til forsiden",
      children: [
        /* @__PURE__ */ n.jsx("div", { style: {
          ...
          width: i,
          height: N,
          transform: `translateX(${N}px) rotate(90deg)`,
          transformOrigin: "0 0"
    ...
    {
      id: t,
      style: { position: "relative", display: "block", height: N, width: i, paddingBottom: _, boxSizing: "content-box", ...h },
      href: g,
      title: "Til forsiden",
      children: [
        c.map((x, m) => /* @__PURE__ */ n.jsx(
          x,
          {
            fill: s,
            style: { position: "absolute", left: v[m] }
  ...
  const d = [H, le, ie, $, fe, pe, le, $, z, H, H, he, me, $, z, Oe, ie], E = {
  ...
  const E = [H, pe, he, me, Se, z, fe, Ae], v = s ? E : E.slice(0, 7), b = {
  ...
  }, w = (b[l] ?? b.DEFAULT).slice(0, v.length);
  return /* @__PURE__ */ n.jsx(
    ve,
    {
      id: t,
