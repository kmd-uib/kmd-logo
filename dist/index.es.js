...
const re = 1 / 60, te = 2, ne = (r) => r.reduce((f, o) => f + o, 0), je = (r, f, o, { k: m, b: c, others: a, ki: h, krandom: d, fcap: w }) => {
  ...
  const d = [y, oe, se, I, ce, le, oe, I, U, y, y, ie, ue, I, U, Oe, se], w = {
  ...
  const d = [y, le, ie, ue, Ae, U, ce, Se], w = {
