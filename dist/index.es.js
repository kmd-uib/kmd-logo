...
function _e() {
  ...
  function o(h, c, a) {
    var m = null;
    if (a !== void 0 && (m = "" + a), c.key !== void 0 && (m = "" + c.key), "key" in c) {
      a = {};
      for (var d in c)
        d !== "key" && (a[d] = c[d]);
    } else a = c;
  ...
  return Q || (Q = 1, process.env.NODE_ENV !== "production" && (function() {
    ...
    function R(e, t, s, l, k, D) {
      ...
      if (B.call(t, "key")) {
        ...
        l = 0 < O.length ? "{key: someKey, " + O.join(": ..., ") + ": ...}" : "{key: someKey}", W[i + l] || (O = 0 < O.length ? "{" + O.join(": ..., ") + ": ...}" : "{}", console.error(
...
React keys must be passed directly to JSX without using spread:
  ...
  <%s key={someKey} {...props} />`,
      ...
      if (i = null, s !== void 0 && (o(s), i = "" + s), m(t) && (o(t.key), i = "" + t.key), "key" in t) {
        s = {};
        for (var H in t)
          H !== "key" && (s[H] = t[H]);
      } else s = t;
    ...
    function _(e) {
      j(e) ? e._store && (e._store.validated = 1) : typeof e == "object" && e !== null && e.$$typeof === N && (e._payload.status === "fulfilled" ? j(e._payload.value) && e._payload.value._store && (e._payload.value._store.validated = 1) : e._store && (e._store.validated = 1));
    }
    function j(e) {
      return typeof e == "object" && e !== null && e.$$typeof === g;
    }
    var v = ge, g = /* @__PURE__ */ Symbol.for("react.transitional.element"), b = /* @__PURE__ */ Symbol.for("react.portal"), p = /* @__PURE__ */ Symbol.for("react.fragment"), u = /* @__PURE__ */ Symbol.for("react.strict_mode"), x = /* @__PURE__ */ Symbol.for("react.profiler"), T = /* @__PURE__ */ Symbol.for("react.consumer"), Y = /* @__PURE__ */ Symbol.for("react.context"), V = /* @__PURE__ */ Symbol.for("react.forward_ref"), he = /* @__PURE__ */ Symbol.for("react.suspense"), me = /* @__PURE__ */ Symbol.for("react.suspense_list"), de = /* @__PURE__ */ Symbol.for("react.memo"), N = /* @__PURE__ */ Symbol.for("react.lazy"), ve = /* @__PURE__ */ Symbol.for("react.activity"), we = /* @__PURE__ */ Symbol.for("react.client.reference"), P = v.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE, B = Object.prototype.hasOwnProperty, Ee = Array.isArray, C = console.createTask ? console.createTask : function() {
      return null;
    };
    v = {
    ...
    var K, Z = {}, $ = v.react_stack_bottom_frame.bind(
      v,
      a
    )(), G = C(h(a)), W = {};
...
const re = 1 / 60, te = 2, ne = (r) => r.reduce((f, o) => f + o, 0), je = (r, f, o, { k: h, b: c, others: a, ki: m, krandom: d, fcap: w }) => {
  ...
  krandom: 1992700730,
  fcap: 15036
}, ae = 57, L = 81, pe = ({ letters: r, targetAnchors: f, width: o, direction: h, color: c, constants: a, style: m, mainPage: d }) => {
  const w = h === U.VERTICAL, [E, R] = z(
    () => f.map((p) => p * (o - ae))
  ), [_, j] = z(
    () => r.map(() => 0)
  ...
  return q(() => {
  ...
  }), [o, h, a, b]), w ? /* @__PURE__ */ n.jsx(
    "a",
    {
      style: { position: "relative", display: "block", width: L, height: o, ...m },
      href: d,
      title: "Til forsiden",
      children: /* @__PURE__ */ n.jsx("div", { style: {
        ...
        {
          fill: c,
          style: { position: "absolute", left: E[u] }
        },
        u
      )) })
    }
    ...
    "a",
    {
      style: { position: "relative", display: "block", height: L, width: o, ...m },
      href: d,
      title: "Til forsiden",
      children: r.map((p, u) => /* @__PURE__ */ n.jsx(
        p,
  ...
  width: r = 420,
  mode: f = ke.DEFAULT,
  direction: o = U.HORIZONTAL,
  color: h = fe.BLACK,
  constants: c,
  style: a,
  mainPage: m
}) => {
  const d = [y, oe, se, F, ce, le, oe, F, I, y, y, ie, ue, F, I, Oe, se], w = {
  ...
  const d = [y, le, ie, ue, Ae, I, ce, Se], w = {
